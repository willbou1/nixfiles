...
(use-package
  ...
  (define-normal-key
    ...
    "w"  '(:prefix-command window-prefix-map		:which-key "Window")
  ...
  (define-normal-key
    :prefix "SPC w"
    :prefix-command 'window-prefix-map
    ...
    "s" '(evil-window-split :which-key "H Split")
    "v" '(evil-window-vsplit :which-key "V Split")
    "m" '(maximize-window :which-key "Maximize")
    "i" '(delete-other-windows :which-key "Isolate")
    "b" '(balance-windows :which-key "Balance")
    )
  (define-normal-key
    :prefix "SPC b"
