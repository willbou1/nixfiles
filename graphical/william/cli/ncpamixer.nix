{pkgs, ...}: {
  ...
  xdg.configFile."ncpamixer.conf".text = ''
    "theme" = "default"
    ...
    # Keybinds {
      ...
      "keycode.112" = "tab_playback"    # f1 VT100
      "keycode.114" = "tab_recording"   # f2 VT100
      "keycode.111" = "tab_output"      # f3 VT100
      "keycode.105" = "tab_input"       # f4 VT100
      "keycode.115" = "tab_config"      # f5 VT100
