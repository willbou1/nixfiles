...
in {
    ...
    services.postgresql = {
        ...
        ensureUsers = map (u: { name = u; ensureDBOwnership = true; }) [
            "synapse" "mautrix-meta-facebook" "mautrix-meta-instagram"
            "matrix-appservice-discord" "grafana" "vaultwarden"
        ];
    };
