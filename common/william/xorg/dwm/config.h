...
static const char *brightupcmd[] = { "brillo", "-u", "150000", "-A", "5", NULL };
static const char *brightdowncmd[] = { "brillo", "-u", "150000", "-U", "5", NULL };
...
static const char *lockcmd[] = { "i3lock-custom", NULL };
static const char *rotatecmd[] = { "xrotate", NULL };
static Key keys[] = {
	/* modifier                     key        function        argument */
    { MODKEY,                       XK_m,                         spawn,          {.v = rotatecmd } },
	...
	{ MODKEY|ShiftMask,             XK_c,                         spawn,          {.v = screencapcmd } },
